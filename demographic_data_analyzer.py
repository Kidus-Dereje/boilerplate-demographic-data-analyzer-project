...
def calculate_demographic_data(print_data=True):
    ...
    with_bach = df[df['education'] == 'Bachelors'].shape[0]
    total = df.shape[0]
    percentage_bachelors = round((with_bach / total) * 100, 1)
    ...
    high_earners_percentage = (high_earners_per_country / total_per_country) * 100
    highest_earning_country = high_earners_percentage.idxmax()
    highest_earning_country_percentage = round(high_earners_percentage.max(), 1)
